 ...
 */
@Parcelize
class LoginInfoResponse : Parcelable {

    var blackCustomer: Boolean = false//黑名单
    lateinit var customerBankCards: List<CustomerBankCards>//
    var customerMobile: String = ""//客户手机
    var customerName: String = ""//客户全名
    var customerSex: Int = 0//客户性别（0：未知；10：男；20：女；30：变性人）
    var customerType: Int = 0//客户类型：10：工人，20：学生，0：其他
    var customerUid: String = ""//客户唯一编号
    var g: Boolean = false//
    var googleTester: Boolean = false//与isG字段一样的值：是否谷歌审核人账号,true：是，false: 否
    var id: Int = 0//客户编号
    var marketId: Int = 0//贷超编号
    var marketType: Int = 0//贷超类型
    var old: Boolean = false//是否老客
