...
object RxToast {
    ...
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(appContext, message, getDrawable(appContext, R.mipmap.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true)
    }
    ...
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(appContext, message, getDrawable(appContext, R.mipmap.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true)
    }
    ...
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(appContext, message, getDrawable(appContext, R.mipmap.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true)
    }
    ...
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(appContext, message, getDrawable(appContext, R.mipmap.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true)
    }
